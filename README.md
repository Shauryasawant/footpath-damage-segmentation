...
Trained on the [Indian Footpath Damage Segmentation Dataset](https://doi.org/10.5281/zenodo.15414238) — real-world footpath images from Indian cities with pixel-wise damage segmentation masks, released on Zenodo by [pritichakurkar](https://github.com/pritichakurkar). 

If you use this model, please credit the original dataset:

```
Indian Footpath Damage Segmentation Dataset. Zenodo. https://doi.org/10.5281/zenodo.15414238
```
